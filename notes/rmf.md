...
Select – Choose the appropriate security controls based on the risk level.

Implement – Put the chosen security controls in place.

Assess – Test and evaluate if the controls are working as expected.

Authorize – Decide if the system is approved to operate based on the risk.

Monitor – Keep track of the system's ongoing security and any changes in risk.
