...
The **NIST Cybersecurity Framework (CSF)** is a **voluntary framework** made up of standards, guidelines, and best practices for managing cybersecurity risk. It is widely respected and used by both public and private organizations to improve their security posture.

---

## 🧩 Core Functions of CSF v2.0

CSF v2.0 includes **six core functions**:
